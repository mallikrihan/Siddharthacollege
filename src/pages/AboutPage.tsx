    ...
    <div className="bg-white min-h-screen">
      ...
      <section className="relative h-[60vh] flex items-center justify-center overflow-hidden bg-primary">
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-white/80 font-sans tracking-wide max-w-2xl mx-auto leading-relaxed">
        ...
        <div className="max-w-[1400px] mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="order-1 lg:order-2 relative rounded-[2rem] lg:rounded-[3rem] overflow-hidden shadow-2xl h-[350px] md:h-[500px]"
            >
              <img 
      ...
      <section className="py-20 md:py-32 bg-slate-50 px-6">
        <div className="max-w-[1400px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <motion.div 
              whileHover={{ y: -10 }}
              className="bg-white p-10 md:p-14 rounded-[2.5rem] shadow-xl shadow-slate-200/50 relative overflow-hidden group"
            >
              <Quote className="absolute top-10 right-10 text-slate-100 group-hover:text-accent/10 transition-colors" size={120} />
      ...
      <section id="facilities" className="py-20 md:py-32 px-6">
        <div className="max-w-[1400px] mx-auto text-center mb-16 md:mb-24">
          <h2 className="text-sm font-bold uppercase tracking-[0.4em] text-accent mb-4">Infrastructure</h2>
          <h3 className="text-4xl md:text-5xl font-serif text-primary">World-Class Facilities</h3>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 lg:gap-12">
            {ACHIEVEMENTS.map((a, i) => (
              <motion.div 
                ...
                className="bg-white/5 backdrop-blur-lg border border-white/10 p-8 md:p-12 rounded-[2.5rem] text-center group hover:bg-white/10 transition-all duration-500"
              >
          ...
          <div className="flex flex-wrap justify-center gap-4 md:gap-6">
            {ALUMNI_COLLEGES.map((college, i) => (
              <motion.div 
                ...
                className="bg-white px-8 py-4 rounded-2xl border border-slate-100 shadow-sm text-primary font-black uppercase tracking-widest text-[11px] md:text-xs flex items-center gap-2"
              >
